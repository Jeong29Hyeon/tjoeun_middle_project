...
<div class="container w-75 text-center">
    <c:if test="${not empty sessionScope.cart}">
        ...
        <div class="d-flex justify-content-center gap-3">
            <h4 class="display-4">총 결제 예정금액 : <span id="totalAmount"></span></h4>
        </div>
        <div>
    ...
    <c:if test="${empty sessionScope.cart}">
        <div class="text-center">
            <h4 class="display-4">구매할 상품이 존재하지 않습니다.</h4>
        </div>
        <div>
            <a href="<c:url value="/store/display"/>"><button class="btn btn-primary">스토어가기</button></a>
        </div>
    </c:if>
</div>
