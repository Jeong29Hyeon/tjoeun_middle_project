...
<div class="container mt-5">
    <div class="row" style="border: 1px black">
        <div class="col-8">
            <div class="row">
                <div class="col">
                    <h5>현재까지 사용 금액: <fmt:formatNumber value="${sumPrice}" pattern="#,###원"/></h5>
                    <br>
                    <h5>${rank}</h5><br>
                    ...
                    <div class="next_rank" style="text-align: center">
                        <c:choose>
                            <c:when test="${nextRank > 0}">
                                <p>NEXT RANK 까지 <span
                                        style="font-size: 20px; color: red;"><fmt:formatNumber
                                        value="${nextRank}" pattern="#,###원"/></span>남았어요!</p>

                            </c:when>
                            <c:otherwise>
                                <p><span style="font-size: 20px; color: red;">최고 등급 입니다!! </span>
                                </p>
                            </c:otherwise>
                        </c:choose>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="row">
                                <div class="col-3"></div>
                                <div class="col-6 col-sm-6"><a class="btn btn-info" role="button"
                        ...
                        <div class="col-6">
                            <div class="row">
                                <div class="col-3"></div>
                                <div class="col-6 col-sm-6"><a class="btn btn-info" role="button"
                                                      href="/user/couponRoom">쿠폰함</a></div>
                                <div class="col-3"></div>
                            </div>
                        </div>
                    </div>
...
<ul class="nav nav-tabs justify-content-center mt-4 nav-fill" id="myTab" role="tablist">
    <li class="nav-item" role="presentation">
        <c:if test="${empty sessionScope.accessToken}">
            <button class="nav-link" id="myInfo-tab" data-bs-toggle="tab" data-bs-target="#myInfo"
                    type="button"
    ...
    <li class="nav-item active" role="presentation">
        <c:if test="${not empty sessionScope.accessToken}">
            <button class="nav-link" id="changeInfo-tab" data-bs-toggle="tab"
                    data-bs-target="#changeInfo"
                    type="button" role="tab" aria-controls="changeInfo" aria-selected="false"
                    disabled>회원정보 변경
            </button>
        </c:if>
        <c:if test="${empty sessionScope.accessToken}">
            <button class="nav-link" id="changeInfo-tab" data-bs-toggle="tab"
                    data-bs-target="#changeInfo"
                    type="button" role="tab" aria-controls="changeInfo" aria-selected="false">회원정보
                변경
            </button>
        </c:if>
    </li>
    ...
    <li class="nav-item" role="presentation">
        <button class="nav-link" id="payHistory-tab" data-bs-toggle="tab"
                data-bs-target="#payHistory" type="button"
...
<div class="container tab-content justify-content-center" id="ticket">
    <div class="container tab-pane fade  text-center" id="myInfo" role="tabpanel"
...
<div class="container tab-pane fade  text-center" id="changeInfo" role="tabpanel"
     aria-labelledby="changeInfo-tab">
    <div class="container mt-5">
        <div class="row">
            <div class="container mt-md-3" style="width: 500px">
...
<div class="container tab-content justify-content-center" id="myTapPayHistory">
    <div class="container tab-pane fade text-left" id="payHistory" role="tabpanel"
         aria-labelledby="payHistory-tab">
        <div class="container mt-3">
            <div class="row">
                ...
                <c:forEach var="ticket" items="${ticketHistory}">
                    ...
                    <div class="col-3 text-center"><fmt:formatNumber value="${ticket.price}"
                                                                     pattern="#,###원"/></div>
                    <div class="col-3 text-center">${ticket.dayInfo}</div>
                    <div class="col-3 text-center">
                        성인${ticket.numberOfAdult}/청소년${ticket.numberOfTeen}</div>
                </c:forEach>
            </div>
            ...
            <div class="row mt-3">
                ...
                <c:forEach var="coupon" items="${couponList}" varStatus="i">
                    ...
                    <div class="col-3 text-center"><fmt:formatNumber value="${coupon.goods.price}"
                                                                     pattern="#,###원"/></div>
                    <div class="col-3 text-center"><fmt:formatDate value="${coupon.purchaseDate}"
                                                                   pattern="yyyy-MM-dd"/></div>
                    <div class="col-3 text-center"><fmt:formatDate value="${coupon.expireDate}"
                                                                   pattern="yyyy-MM-dd"/></div>
                </c:forEach>
            </div>
        </div>
