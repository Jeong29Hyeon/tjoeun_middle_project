...
<form action="/movieRoom" method="post" id="movieSelectForm">
    <div class="container text-center mt-5">
        <div class="row">
            <div class="col">
                <div class="col">
                    <input type="hidden" id="titleInfo" name="titleInfo" value="">
                </div>
            </div>
            <div class="col">
                <div class="col">
                    <input type="hidden" id="dayInfo" name="dayInfo" value="">
                </div>
            </div>
            <div class="col">
                <input type="hidden" id="hallInfo" name="hallInfo" value="">
            </div>

            <div class="col">
                <div class="col">
                    <input type="hidden" id="timeInfo" name="timeInfo" value="">
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="modal-body">
                <form name="loginForm" class="row g-3" action="<c:url value='/user/login'/>"
                    ...
                    <div class="row mt-md-3">
                        ...
                        <div class="col">
                            <a href="<c:url value="#"/>"
                               style="text-decoration: none; font-size: 12px">아이디 혹은 비밀번호를 잊으셨나요?</a>
                        </div>
                    </div>
